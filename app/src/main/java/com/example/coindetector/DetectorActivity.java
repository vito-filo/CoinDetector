...
public class DetectorActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    private DetectorClassifier detector;

    private long lastProcessingTimeMs;
    private Bitmap rgbFrameBitmap = null;
    private Bitmap rgbVertivalBitmap = null;
    ...
    public void onPreviewSizeChosen(final Size size, final int rotation) {
        ...
        croppedBitmap = Bitmap.createBitmap(480, 640, Config.ARGB_8888);
        ...
        runInBackground(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        final List<DetectorClassifier.Recognition> results = detector.recognizeImage(croppedBitmap);
